...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🎯 Vibble website loaded successfully!');
});
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key.toLowerCase() === 'v') {
        showNotification('🎉 Vibble'ı keşfettin! Kararsızlığı unut!', 'success');
    }
});
...
window.addEventListener('load', function() {
    ...
    setTimeout(() => {
        showNotification('🎯 Vibble web sitesine hoş geldiniz!', 'success');
    }, 1000);
});
